...
I treated this as a two-part membership check:

- split the input into words
- ensure there are exactly 2 words
- check first word in the valid-first list
- check second word in the valid-second list

I used `includes` for each list and returned the combined boolean directly.
