...
At first I thought we could solve this with a simple regex but after really thinking about it, I think a regex would be over kill. Instead we can look at the first letter of the name and did an if on that and then add it all back together again in the return.
