...
- Modeling explicit states (cash, long, short) makes constraints like:
    - no overlapping transactions
    - no same-day open/close
naturally enforced.
- When constraints get complex, tracking “what I’m holding” is often more powerful than tracking actions.
- DP problems often become simpler when you think in terms of valid transitions between states, instead of trying to enumerate all possible trades.
