...
- Prefix sums are an excellent tool for optimizing problems that involve repeated range calculations.
- Even when only one modification is allowed, enumerating all valid positions efficiently can make the difference between a time-out and an optimal solution.
- Problems that look like dynamic programming at first may actually be simpler linear scans once reframed correctly.
